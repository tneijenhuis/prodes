    ...
    for cell in grid_cells:
        ...
        if not cell.empty:
            ...
            for atom in cell.filtered_content("Atom"):
                ...
                valid_neighbors = [n for n in neighbourhood if n.radius is not None and n is not atom]
                ...
                for i in surf_indices:
                    surf_point = Surface_point(sphere_coords[i, 0], sphere_coords[i, 1], sphere_coords[i, 2], atom)
